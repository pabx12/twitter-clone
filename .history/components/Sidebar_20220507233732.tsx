  ...
  return (
    <div className='col-span-2 flex flex-col items-center px-4 md:items-start'>
        ...
        <div className='flex items-center'>
          <button className='flex max-w-fit items-center space-x-2 px-4 py-3 rounded-lg group hover:bg-gray-100 cursor-pointer  transition-all duration-200'>Tweet</button>
        </div>
    </div>
  )
}
