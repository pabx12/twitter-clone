  ...
  return (
    <div className='flex flex-col space-x-3 border-y border-gray-100 p-5'>
            ...
            <div className='flex justify-between mt-5'>
                <div  onClick={() => setCommentBoxOpen(!commentBoxOpen) } className='flex items-center space-x-3 text-gray-400'>
            ...
            {commentBoxOpen && 
                (
                    <form className='mt-3 flex space-x-3'>
                        <input type="text" placeholder="Leave a comment" className='flex-1 rounded-lg bg-gray-100 p-2 outline-none'/>
                        <button type="submit" className='text-twitter disabled:text-gray-200'>Send</button>
                    </form>
                )
            }
         {/* CommentBox */}
